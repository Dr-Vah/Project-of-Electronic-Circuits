...
/* The controller maps WhiteBallDetection results through a logical 180-degree
 * rotation, preserving the already tuned transport geometry. Detector
 * centre_x uses -1 at the corrected left and +1 at the corrected right. */
