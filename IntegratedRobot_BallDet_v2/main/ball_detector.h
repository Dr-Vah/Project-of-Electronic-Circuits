...
/* Imported from dev/BallDet/main at commit 9f08d21. Pixels are byte-swapped
 * RGB565 as produced by esp_jpeg with swap_color_bytes=1. Coordinates are
 * reported in the original input frame. */
